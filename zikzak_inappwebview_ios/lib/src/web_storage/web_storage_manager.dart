...
class IOSWebStorageManager extends PlatformWebStorageManager
  ...
  Future<void> deleteAllData() async {
    final Set<WebsiteDataType> dataTypes = Set.from(WebsiteDataType.values);
    await removeDataModifiedSince(
        dataTypes: dataTypes, date: DateTime.fromMillisecondsSinceEpoch(0));
  }
