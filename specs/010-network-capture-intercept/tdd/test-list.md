...
| A10 | Per-domain maxEntries budget enforced: capture stops at limit for that domain only | US4-AC1    | example   | PENDING  |                                           |
| A11 | Per-domain maxBytes budget enforced: capture stops at limit for that domain only | US4-AC2    | example   | PENDING  |                                           |
