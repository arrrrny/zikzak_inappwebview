...
| --- | ----------------------------------------------------------- | ------ | ------- | ------- | ------------------------------------------- |
| A1  | macOS takeScreenshot returns non-null Uint8List with valid PNG image data | US1-AC1 | example | PENDING |                                             |
...
| A4  | Android createPdf returns non-null Uint8List with valid PDF data | US2-AC1 | example | PENDING |                                             |
