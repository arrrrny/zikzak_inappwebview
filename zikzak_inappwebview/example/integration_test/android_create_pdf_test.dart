...
void main() {
  ...
  Future<InAppWebViewController> pumpWebView(
    ...
    String content =
        '<html><body><h1>pdf</h1><p>hello zikzak</p></body></html>',
  }) async {
  ...
  testWidgets('A4 Android createPdf returns non-null valid PDF bytes', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        String.fromCharCodes(pdf!.sublist(0, 5)).startsWith('%PDF'),
        isTrue,
