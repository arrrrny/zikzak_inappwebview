...
class ServiceWorkerController {
  ...
  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.serviceWorkerClient}
  ...
  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.getAllowFileAccess}
  static Future<bool> getAllowFileAccess() =>
      PlatformServiceWorkerController.static().getAllowFileAccess();

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads}
  static Future<bool> getBlockNetworkLoads() =>
      PlatformServiceWorkerController.static().getBlockNetworkLoads();

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.getCacheMode}
  static Future<CacheMode?> getCacheMode() =>
      PlatformServiceWorkerController.static().getCacheMode();

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.setAllowContentAccess}
  static Future<void> setAllowContentAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowContentAccess(allow);

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.setAllowFileAccess}
  static Future<void> setAllowFileAccess(bool allow) =>
      PlatformServiceWorkerController.static().setAllowFileAccess(allow);

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads}
  static Future<void> setBlockNetworkLoads(bool flag) =>
      PlatformServiceWorkerController.static().setBlockNetworkLoads(flag);

  ///{@macro zikzak_inappwebview_platform_interface.PlatformServiceWorkerController.setCacheMode}
...
class AndroidServiceWorkerController {
  ...
  static Future<CacheMode?> getCacheMode() async {
    return await ServiceWorkerController.getCacheMode();
  }
