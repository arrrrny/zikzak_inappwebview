...
///{@template zikzak_inappwebview_platform_interface.PlatformPrintJobController}
...
abstract class PlatformPrintJobController extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformPrintJobController.id}
  ///Print job ID.
  ///{@endtemplate}
  String get id => params.id;

  ///{@template zikzak_inappwebview_platform_interface.PlatformPrintJobController.onComplete}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformPrintJobController.cancel}
  ...
  ///
  ///You should dismiss the printing settings when they are presented in a sheet or
  ...
  ///You should then present the printing settings again once the new orientation takes effect.
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS
  ///{@endtemplate}
