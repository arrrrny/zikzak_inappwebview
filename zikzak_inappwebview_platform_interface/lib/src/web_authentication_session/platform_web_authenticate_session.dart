...
///{@template zikzak_inappwebview_platform_interface.PlatformWebAuthenticationSession}
...
abstract class PlatformWebAuthenticationSession extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformWebAuthenticationSession.id}
  ///ID used internally.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template zikzak_inappwebview_platform_interface.PlatformWebAuthenticationSession.url}
