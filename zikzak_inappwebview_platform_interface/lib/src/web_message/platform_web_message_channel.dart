...
abstract class PlatformWebMessageChannel extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformWebMessageChannel.id}
  ///Message Channel ID used internally.
  ///{@endtemplate}
  String get id => params.id;

  ///{@template zikzak_inappwebview_platform_interface.PlatformWebMessageChannel.port1}
  ///The first [PlatformWebMessagePort] object of the channel.
  ///{@endtemplate}
  PlatformWebMessagePort get port1 => params.port1;

  ///{@template zikzak_inappwebview_platform_interface.PlatformWebMessageChannel.port2}
