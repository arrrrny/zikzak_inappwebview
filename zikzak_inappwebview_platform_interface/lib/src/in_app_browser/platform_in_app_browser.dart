...
///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser}
...
abstract class PlatformInAppBrowser extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.id}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.contextMenu}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.pullToRefreshController}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.findInteractionController}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.initialUserScripts}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.windowId}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.webViewController}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.openUrlRequest}
  ...
  ///
  ///[assetFilePath]: The asset file path to load.
  ///
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.hide}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppBrowser.close}
...
abstract class PlatformInAppBrowserEvents {
  ...
  ///
  ///**NOTE**: In order to be able to listen this event, you need to set [InAppWebViewSettings.useShouldInterceptRequest] setting to `true`.
  ///
  ///**Officially Supported Platforms/Implementations**:
