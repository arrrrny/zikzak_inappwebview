...
class PlatformHeadlessInAppWebViewCreationParams
  ...
  const PlatformHeadlessInAppWebViewCreationParams({
    ...
    super.onNetworkRequest,
    super.onNetworkResponse,
    super.onNetworkLoadingFinished,
...
///{@template zikzak_inappwebview_platform_interface.PlatformHeadlessInAppWebView}
...
abstract class PlatformHeadlessInAppWebView extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformHeadlessInAppWebView.id}
  ///View ID.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template zikzak_inappwebview_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformHeadlessInAppWebView.isRunning}
