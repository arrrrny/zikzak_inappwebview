...
abstract class PlatformNavigationDelegate extends PlatformInterface {
  ...
  Future<WebUri?> getUrl() {
    throw UnimplementedError('getUrl is not implemented on the current platform');
  }
  ...
  Future<int?> getProgress() {
    throw UnimplementedError('getProgress is not implemented on the current platform');
  }
  ...
  Future<void> loadUrl(
    ...
    throw UnimplementedError('loadUrl is not implemented on the current platform');
  }
  ...
  Future<void> postUrl({required WebUri url, required Uint8List postData}) {
    throw UnimplementedError('postUrl is not implemented on the current platform');
  }
  ...
  Future<void> loadData(
    ...
    throw UnimplementedError('loadData is not implemented on the current platform');
  }
  ...
  Future<bool> isLoading() {
    throw UnimplementedError('isLoading is not implemented on the current platform');
  }

  ///{@macro zikzak_inappwebview_platform_interface.PlatformInAppWebViewController.stopLoading}
  Future<void> stopLoading() {
    throw UnimplementedError('stopLoading is not implemented on the current platform');
  }
}
