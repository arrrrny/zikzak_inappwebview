...
///{@template zikzak_inappwebview_platform_interface.PlatformPullToRefreshController}
...
abstract class PlatformPullToRefreshController extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformPullToRefreshController.settings}
  /// Initial settings.
  ///{@endtemplate}
  PullToRefreshSettings? get settings => params.settings;

  ///{@template zikzak_inappwebview_platform_interface.PlatformPullToRefreshController.onRefresh}
  ///Event called when a swipe gesture triggers a refresh.
  ///{@endtemplate}
  void Function()? get onRefresh => params.onRefresh;

  ///{@template zikzak_inappwebview_platform_interface.PlatformPullToRefreshController.setEnabled}
