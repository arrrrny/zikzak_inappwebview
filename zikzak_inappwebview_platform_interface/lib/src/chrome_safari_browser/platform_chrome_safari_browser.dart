...
///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser}
...
abstract class PlatformChromeSafariBrowser extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.id}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.open}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.launchUrl}
...
abstract class PlatformChromeSafariBrowserEvents {
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onServiceConnected}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onOpened}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onCompletedInitialLoad}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onInitialLoadDidRedirect}
  ///Event fired when the initial URL load is complete.
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onNavigationEvent}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onRelationshipValidationResult}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onMessageChannelReady}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onPostMessage}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onVerticalScrollEvent}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onGreatestScrollPercentageIncreased}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onSessionEnded}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformChromeSafariBrowser.onClosed}
