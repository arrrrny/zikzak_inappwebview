...
///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer}
...
abstract class PlatformInAppLocalhostServer extends PlatformInterface {
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer.port}
  ///Represents the port of the server. The default value is `8080`.
  ///{@endtemplate}
  int get port => params.port;

  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  ///represents the index file to use. The default value is `index.html`.
  ///{@endtemplate}
  String get directoryIndex => params.directoryIndex;

  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  ///Represents the document root path to serve. The default value is `./`.
  ///{@endtemplate}
  String get documentRoot => params.documentRoot;

  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer.shared}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformInAppLocalhostServer.start}
