...
///{@template zikzak_inappwebview_platform_interface.PlatformWebStorage}
...
abstract class PlatformWebStorage extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformWebStorage.localStorage}
  ///Represents `window.localStorage`.
  ///{@endtemplate}
  PlatformLocalStorage get localStorage => params.localStorage;

  ///{@template zikzak_inappwebview_platform_interface.PlatformWebStorage.sessionStorage}
...
///{@template zikzak_inappwebview_platform_interface.PlatformStorage}
...
abstract mixin class PlatformStorage implements Disposable {
  ///{@template zikzak_inappwebview_platform_interface.PlatformStorage.controller}
  ///Controller used to interact with storage.
  ///{@endtemplate}
  PlatformInAppWebViewController? get controller;

  ///{@template zikzak_inappwebview_platform_interface.PlatformStorage.webStorageType}
...
///{@template zikzak_inappwebview_platform_interface.PlatformLocalStorage}
...
///{@template zikzak_inappwebview_platform_interface.PlatformSessionStorage}
