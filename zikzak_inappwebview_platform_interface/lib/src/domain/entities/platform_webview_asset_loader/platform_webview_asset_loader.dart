...
import '../web_resource_response/web_resource_response.dart';

part 'platform_webview_asset_loader.zorphy.dart';
...
abstract class $WebViewAssetLoader {
  ...
  @JsonKey(fromJson: _pathHandlersFromJson, toJson: _pathHandlersToJson)
  List<PlatformPathHandler>? get pathHandlers;
}
...
class PlatformPathHandlerCreationParams {
  ...
  ///{@macro zikzak_inappwebview_platform_interface.PlatformPathHandler.path}
  final String path;
}

///{@template zikzak_inappwebview_platform_interface.PlatformPathHandler}
...
abstract class PlatformPathHandler {
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformPathHandler.type}
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformPathHandler.path}
...
abstract class PlatformPathHandlerEvents {
  ///{@template zikzak_inappwebview_platform_interface.PlatformPathHandler.handle}
...
///{@template zikzak_inappwebview_platform_interface.PlatformAssetsPathHandler}
...
///{@template zikzak_inappwebview_platform_interface.PlatformResourcesPathHandler}
...
///{@template zikzak_inappwebview_platform_interface.PlatformInternalStoragePathHandler}
...
///{@template zikzak_inappwebview_platform_interface.PlatformCustomPathHandler}
