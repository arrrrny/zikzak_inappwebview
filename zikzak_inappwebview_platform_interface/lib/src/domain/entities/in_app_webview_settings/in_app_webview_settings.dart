...
List<ContentBlocker> _deserializeContentBlockers(Object? contentBlockersMapList) {
...
abstract class $InAppWebViewSettings {
  ...
  @JsonKey(defaultValue: ForceDarkStrategy.PREFER_WEB_THEME_OVER_USER_AGENT_DARKENING)
  ...
  @JsonKey(fromJson: _defaultVideoPosterFromJson, toJson: _defaultVideoPosterToJson)
  ...
  @JsonKey(fromJson: _allowingReadAccessToFromJson, toJson: _allowingReadAccessToToJson)
  ...
  @JsonKey(fromJson: _minimumViewportInsetFromJson, toJson: _minimumViewportInsetToJson)
  ...
  @JsonKey(fromJson: _maximumViewportInsetFromJson, toJson: _maximumViewportInsetToJson)
...
Uint8List? _defaultVideoPosterFromJson(Object? value) => value == null
    ? null
...
WebUri? _allowingReadAccessToFromJson(Object? value) => value == null
    ? null
    : WebUri(value as String);
...
UrlPatternType? _urlPatternTypeFromJson(Object? value) => value == null
    ? null
    : UrlPatternType.fromNativeValue(value as String);

Object? _urlPatternTypeToJson(UrlPatternType? value) =>
    value?.toNativeValue();
