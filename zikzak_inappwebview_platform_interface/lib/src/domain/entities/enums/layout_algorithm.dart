...
LayoutAlgorithm? layoutAlgorithmFromWire(Object? value) =>
    value is String ? LayoutAlgorithm.values.firstWhere((e) => e.name == value, orElse: () => LayoutAlgorithm.values.first) : null;
