...
scrollViewContentInsetAdjustmentBehaviorFromWire(Object? value) {
  if (value is! int) return null;
  return value >= 0 &&
          value < ScrollViewContentInsetAdjustmentBehavior.values.length
      ? ScrollViewContentInsetAdjustmentBehavior.values[value]
      : null;
}

Object? scrollViewContentInsetAdjustmentBehaviorToWire(
