...
ScrollViewDecelerationRate? scrollViewDecelerationRateFromWire(Object? value) =>
    value is String
    ? ScrollViewDecelerationRate.values.firstWhere(
        (e) => e.name == value,
        orElse: () => ScrollViewDecelerationRate.values.first,
      )
    : null;

String? scrollViewDecelerationRateToWire(ScrollViewDecelerationRate? value) =>
    value?.name;
