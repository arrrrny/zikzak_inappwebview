...
import '../proxy_rule/proxy_rule.dart';
import '../platform_webview_feature/platform_webview_feature.dart';

part 'platform_proxy_controller.zorphy.dart';
...
abstract class PlatformProxyController extends PlatformInterface
  ...
  ///{@template zikzak_inappwebview_platform_interface.PlatformProxyController.setProxyOverride}
...
abstract class $IOSProxySettings {
...
abstract class $AndroidProxySettings {
